! function(i) {
    ...
    (e = function() {
        ...
        var i = this;
        if (1 === i.options.slidesToShow && !0 === i.options.adaptiveHeight && !1 === i.options.vertical) {
            var e = Math.round(100 * i.$slides.eq(i.currentSlide)[0].getBoundingClientRect().height) / 100 + (i.$slides.eq(i.currentSlide).outerHeight(!0) - i.$slides.eq(i.currentSlide).height());
            i.$list.css("height", e)
        }
